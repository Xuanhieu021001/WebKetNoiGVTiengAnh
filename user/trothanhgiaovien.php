...
<head>
    ...
    <title>Trở thành giáo veien</title>
...
<body>
    ...
    <container class="trothanhgv">
        <div class="bctc-container">
            ...
            <div class="law">
                <input type="checkbox" name="" id="hi" value="" class="check"> 
                <label for="hi"> I agree with all requirements and regulations at Tmarket</label>
            </div>
            <a href="dangnhap.php"><div class="btn-register">Register now</div></a>
        </div>
    </container>
