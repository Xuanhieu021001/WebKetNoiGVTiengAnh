<?php
	...
	function ktra($cahoc,$result){  
        foreach ($result as $items)
        {
            if($items['cahoc'] == $cahoc){
                return true;
            }
        }
        return false;
