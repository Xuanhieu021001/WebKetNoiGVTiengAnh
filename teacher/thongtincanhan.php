	...
	if(isset($_POST['submit_ttcb'])){
		if(!empty($_POST['ho']) && !empty($_POST['ten']) && !empty($_POST['ngaysinh']) && !empty($_POST['gioitinh']) && !empty($_POST['email']) && !empty($_POST['sdt']) && !empty($_POST['quocgia']) && !empty($_POST['timezone']) && !empty($_POST['diachi'])){
			...
			echo "Không có  ảnh";
				...
				$anh = "./img/profile/".$id_teacher."1".$seo.".jpg";
	...
	if(isset($_POST['submit_chungchi'])){
		if(!file_exists($_FILES['anh1']['tmp_name']) || !is_uploaded_file($_FILES['anh1']['tmp_name'])){
			echo "Không có  ảnh";
				...
				include("randomstring.php");
				$seo = generate_string($permitted_chars, 5);
				$anh1 = "./img/idcard/".$id_teacher."1".$seo.".jpg";
		...
		if(!file_exists($_FILES['anh2']['tmp_name']) || !is_uploaded_file($_FILES['anh2']['tmp_name'])){
			echo "Không có  ảnh";
				...
				include("randomstring.php");
				$seo = generate_string($permitted_chars, 5);
				$anh2 = "./img/idcard/".$id_teacher."2".$seo.".jpg";
			...
			echo "Không có  ảnh";
				...
				include("randomstring.php");
				$seo = generate_string($permitted_chars, 5);
				$anh3 = "./img/chungchi/".$id_teacher."1".$seo.".jpg";
			...
			echo "Không có  ảnh";
				...
				include("randomstring.php");
				$seo = generate_string($permitted_chars, 5);
				$anh4 = "./img/chungchi/".$id_teacher."1".$seo.".jpg";
			...
			echo "Không có  ảnh";
				...
				include("randomstring.php");
				$seo = generate_string($permitted_chars, 5);
				$anh5 = "./img/congcudayhoc/".$id_teacher."5".$seo.".jpg";
			...
			echo "Không có  ảnh";
				...
				include("randomstring.php");
				$seo = generate_string($permitted_chars, 5);
				$anh6 = "./img/congcudayhoc/".$id_teacher."1".$seo.".jpg";
			...
			echo "Không có  ảnh";
				...
				include("randomstring.php");
				$seo = generate_string($permitted_chars, 5);
				$anh7 = "./img/congcudayhoc/".$id_teacher."1".$seo.".jpg";
			...
			echo "Không có  ảnh";
				...
				include("randomstring.php");
				$seo = generate_string($permitted_chars, 5);
				$anh8 = "./img/congcudayhoc/".$id_teacher."1".$seo.".jpg";
	...
	if(isset($_POST['submit_video'])){
		if(!file_exists($_FILES['video']['tmp_name']) || !is_uploaded_file($_FILES['video']['tmp_name'])){
			echo "Không có video";
				...
				include("randomstring.php");
				$seo = generate_string($permitted_chars, 5);
				$video = "./video/".$id_teacher."1".$seo.".mp4";
